...
class GetRelatedLinksServiceTest {
  ...
  void getRelatedLinks_shouldReturnRelatedLinks_whenLinksExist() {
    ...
    List<Link> relatedLinks = Arrays.asList(
      new Link("link-2", "https://example.com/2", "Related 1", "Desc 1", LocalDateTime.now(), "text/html"),
      new Link("link-3", "https://example.com/3", "Related 2", "Desc 2", LocalDateTime.now(), "text/html"),
      new Link("link-4", "https://example.com/4", "Related 3", "Desc 3", LocalDateTime.now(), "text/html")
    );
