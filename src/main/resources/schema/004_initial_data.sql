...
CREATE INDEX ON User(createdAt) NOTUNIQUE;
CREATE INDEX ON User(lastLoginAt) NOTUNIQUE;
CREATE INDEX ON AuthToken(createdAt) NOTUNIQUE;
CREATE INDEX ON AuthToken(userId, tokenType, expiresAt, isRevoked) NOTUNIQUE    ;
