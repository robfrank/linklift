...
public interface JwtTokenPort {
   ...
   */
  @NonNull
  Optional<TokenClaims> validateToken(@NonNull String token);
   ...
   */
  @NonNull
  Optional<String> extractUserIdFromToken(@NonNull String token);
   ...
   */
  @NonNull
  Optional<LocalDateTime> getTokenExpiration(@NonNull String token);
